...
1. **Disturbance:** Does this increase or decrease soil disturbance? Does it affect fungal networks? Is that disturbance necessary, or is there a lower-disturbance option?
2. **Root continuity:** Does this leave living roots in the ground, or create bare periods?
3. **Coverage:** Does this leave soil covered or exposed?
4. **Diversity:** Does this increase or decrease species diversity — plant, microbial, animal, habitat?
5. **Cycles:** Does this close or open nutrient and energy cycles on-farm? Does it import fertility or build internal cycling?
6. **Ecosystem trajectory:** In ten years, does this decision make the farm more or less ecologically complex? More or less dependent on external inputs?
